...
@Entity
public class RespTecnico implements Serializable{
    ...
    public RespTecnico(Integer id, String nome, String logradouro, String bairro_localidade, String cidade,
            String estado, String cep, String email, String crea, String telefone1, String telefone2) {
        this.id = id;
        this.nome = nome;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RespTecnico other = (RespTecnico) obj;
        if (id == null) {
            if (other.id != null)
                return false;
